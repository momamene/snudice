...
public class Const {
	...
	public static int articlePerPage = 12; //게시판 한 페이지당 보여줄 글 수
	...
	public static int commentMaxLen = 100; //자기소개의 최대 길이(byte 수)
	...
	public static int replyLimit = 200; //한 글당 달수 있는 댓글의 제한 개수
}
