				...
				switch(i) {
					case 0 :
						if(mode==1)
							...
							bmpKind[nowConPoint.x][nowConPoint.y].tileType=TY_CLASS;
							InvalidateRect(hC1,NULL,TRUE);
						break;
					case 1 :
						if(mode==1)
							tempBmpKind.tileType=TY_ITEM;
						else if(mode==2)
							bmpKind[nowConPoint.x][nowConPoint.y].tileType=TY_ITEM;
							InvalidateRect(hC1,NULL,TRUE);
						break;
					case 2 :
						if(mode==1)
							tempBmpKind.tileType=TY_STAMINA;
						else if(mode==2)
							bmpKind[nowConPoint.x][nowConPoint.y].tileType=TY_STAMINA;
							InvalidateRect(hC1,NULL,TRUE);
						break;
					case 3 :
						if(mode==1)
							tempBmpKind.tileType=TY_BUS;
						else if(mode==2)
							bmpKind[nowConPoint.x][nowConPoint.y].tileType=TY_BUS;
							InvalidateRect(hC1,NULL,TRUE);
						break;

					case 4 :
						if(mode==1)
							tempBmpKind.tileType=TY_MAINGATE;
						else if(mode==2)
							bmpKind[nowConPoint.x][nowConPoint.y].tileType=TY_MAINGATE;
							InvalidateRect(hC1,NULL,TRUE);
						break;
					case 5 :
						if(mode==1)
							tempBmpKind.tileType=TY_NONE;
						else if(mode==2)
							bmpKind[nowConPoint.x][nowConPoint.y].tileType=TY_NONE;
							InvalidateRect(hC1,NULL,TRUE);
						break;
				}
			}
